...
class EANHLSearchDestinationString extends ObjectBase implements IEANHLSearch {
	...
	/**
	 * (non-PHPdoc)
	 * @see \zamnuts\EANAPIClient\Query\LandmarkListSearch\IEANHLSearch::isValid()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see \zamnuts\EANAPIClient\Query\LandmarkListSearch\IEANHLSearch::renderPreparedArray()
	 */
